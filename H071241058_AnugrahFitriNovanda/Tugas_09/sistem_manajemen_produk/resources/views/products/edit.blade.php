        ...
        <div class="bg-white rounded-xl shadow-2xl p-6 sm:p-8 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="price" id="price" step="0.01" min="0" class="input-field" 
                           value="{{ old('price', $product->price) }}" required>
                </div>
                <div>
                    <label for="sku" class="block text-sm font-medium text-gray-700 mb-2">SKU (Wajib, Unik)</label>
                    <input type="text" name="sku" id="sku" class="input-field" 
        ...
        <div class="bg-white rounded-xl shadow-2xl p-6 sm:p-8 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="weight" id="weight" step="0.01" min="0" class="input-field" 
                           value="{{ old('weight', $product->productDetail->weight ?? '') }}" required>
                </div>
                <div>
                    <label for="size" class="block text-sm font-medium text-gray-700 mb-2">Ukuran (Opsional)</label>
                    <input type="text" name="size" id="size" class="input-field" 
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="4" 
                              class="input-field">{{ old('description', $product->productDetail->description ?? '') }}</textarea>
                </div>
            </div>
        </div>
